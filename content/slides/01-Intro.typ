...
#slide(composer: (1.1fr, 0.9fr))[
  ...
  #image-plate("/slides/01-Intro-Assests/austin_grad.jpg")
]
...
#slide(composer: (0.85fr, 1.15fr))[
  ...
  I helped build *PIXLISE*, an open-source tool for analyzing chemical and mineral data beamed back from NASA's Perseverance rover on Mars.
    ...
    #v(2fr)
  #image-plate(
    "/slides/01-Intro-Assests/nasa_data.png",
    width: 100%,
...
#v(1fr)
  ...
  #image-plate(
    "/slides/01-Intro-Assests/global_data.png",
...
#slide[
  ...
  #grid(
    ...
    align: horizon,
    image-plate(
      "/slides/01-Intro-Assests/education_data.png",
      height: 68%,
      source: [Cal Poly course-equity dashboards.],
    ),
    image-plate(
      "/slides/01-Intro-Assests/grade_data.png",
      height: 68%,
      source: [Cal Poly course-equity dashboards.],
    ),
  )
...
#slide[
  ...
  #grid(
    ...
    align: horizon,
    image-plate(
      "/slides/01-Intro-Assests/apple_watch.png",
      height: 64%,
    ),
    image-plate("/slides/01-Intro-Assests/health_data.png", height: 64%),
  )
]

#slide[
  #image-plate(
    "/slides/01-Intro-Assests/climate_bands.png",
    height: 78%,
    border: false,
    shadow: false,
...
#slide[
  #image-plate(
    "/slides/01-Intro-Assests/covid.png",
...
#slide[
  #image-plate(
    "/slides/01-Intro-Assests/flatten_the_curve.jpg",
...
#slide[
  #image-plate(
    "/slides/01-Intro-Assests/challenger.png",
...
#slide[
  ...
  #image-plate(
    "/slides/01-Intro-Assests/o_ring.png",
...
#slide[
  #image-plate(
    "/slides/01-Intro-Assests/feynman.png",
    height: 75%,
...
#slide[
  #v(1fr)
  #image-plate(
    "/slides/01-Intro-Assests/concern.png",
    height: 55%,
...
#slide[
  #image-plate(
    "/slides/01-Intro-Assests/bad_vis_legend.png",
...
#slide[
  #image-plate(
    "/slides/01-Intro-Assests/bad_vis.png",
...
#slide[
  #image-plate(
    "/slides/01-Intro-Assests/challenger_tufte-9937.png",
...
#slide[
  #image-plate(
    "/slides/01-Intro-Assests/spreadsheet.png",
    height: 78%,
...
#slide[
  #image-plate("/slides/01-Intro-Assests/minard.png", source: [Source plate: Charles Minard, 1861.])
]

#slide[
  #image-plate(
    "/slides/01-Intro-Assests/dubois.png",
    height: 78%,
...
#slide[
  #image-plate(
    "/slides/01-Intro-Assests/cholera_data.png",
...
#slide[
  #image-plate("/slides/01-Intro-Assests/nba_data.png", source: [Kirk Goldsberry.])
]

#slide[
  #image-plate("/slides/01-Intro-Assests/data_beads.png", source: [Data Beads, Eszter Katona and Mihály Minkó, 2024.])
]
