...
#let ex = "lab-activities/01-Sketching-Activity-Assests"
...
#focus-slide()[
  Finally, how many *more* ways can you visualize these two numbers:
  ...
  #small()[Really start to think outside of the box, and/or add variations and combinations of the visuals you have seen so far]
  #v(1fr)
