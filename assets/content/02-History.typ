...
#slide()[
  ...
  #v(2fr)
    ...
    #image-plate("02-History-Assests/tablet.jpg")
  ]

#slide()[
    #image-plate("02-History-Assests/pythagorean_1.png")
  ][
    #image-plate("02-History-Assests/pythagorean_2.png",caption: [Visual Proof of the Pythagorean Theorem])
  ]

  #slide()[
      #image-plate("02-History-Assests/macrobius.jpg", width: 100%, caption:[Macrobius])
    ][
      #image-plate("02-History-Assests/tree_of_life.svg", caption:[The Tree of Life])
    ][
      #image-plate("02-History-Assests/chain_of_being.jpg", caption:[The Great Chain of Being])
   ]


#slide[
  #image-plate("02-History-Assests/mappa_mundi.jpg", caption:[Mappa Mundi, c.1300])
][
  #image-plate("02-History-Assests/portolan.jpg", width: 100%, caption:[Portolan Chart with rhumb lines, c.1466])
]

#slide[
  #image-plate("02-History-Assests/galileo_moon.jpg", caption:[Galileo Survey of Lunar Surface])
][
  #image-plate("02-History-Assests/1684_france.jpg", width: 100%, caption:[Map showing improvements in surveying])
]
...
#slide(composer: (1fr, 1fr))[
  #image-plate(
    "02-History-Assests/playfair_chart.jpg",
    width: 100%,
...
#slide[
  #image-plate(
    "02-History-Assests/nightingale_mortality.jpg",
    height: 78%,
...
#slide[
  ...
  #image-plate(
    "02-History-Assests/snow_cholera_map.jpg",
    height: 78%,
...
#slide[
  #image-plate(
    "02-History-Assests/minard_1869.jpg",
    height: 78%,
...
#slide[
  ...
  #image-plate(
    "02-History-Assests/dubois_spiral.jpg",
    height: 85%,
...
#slide[
  ...
  #image-plate(
    "02-History-Assests/isotype_basic_1937.jpg",
    height: 85%,
...
#slide[
  ...
  #image-plate(
    "02-History-Assests/isotype_neurath.jpg",
    height: 85%
  )
]
...
#slide[
  #image-plate(
    "02-History-Assests/bauhaus_dessau.jpg",
    height: 78%,
...
#slide[
  ...
  #image-plate("02-History-Assests/bauhaus.jpg")
]
#slide()[  #image-plate("02-History-Assests/1908_tube_map.jpg",caption:[1908 London Underground Map])
][  #image-plate("02-History-Assests/beck_map.jpg",caption:[Harry Beck London Underground Map])
]
...
#slide[
  ...
  *Semiology of Graphics, 1967*: Systematization of design, first introduction of graphical grammar.
  ...
  #image-plate(
    "02-History-Assests/bertin_visual_variables.svg",
    height: 78%,
...
#v(1fr)
  #image-plate(
    "02-History-Assests/boxplot_anatomy.svg",
    width: 100%,
...
#body-copy[
  ...
  #image-plate(
    "02-History-Assests/cleveland_mcgill.png",
    height: 78%,
...
#slide[
  ...
  #image-plate("02-History-Assests/nyt.png",height: 60%,caption:[Major outlets such as the New York Times have placed substantial emphasis on interactive data visualization in journalism.])
]
